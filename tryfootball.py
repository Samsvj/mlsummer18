...
img_list=os.listdir('/root/Desktop/ml/football_players')
print(img_list)

#storing first image in the numpy array x
x=cv2.imread('/root/Desktop/ml/football_players/8.jpg',0)
...
for i in img_list:
	...
	#loading the lest over images in the numpy array
		...
		print(i)
		y=cv2.imread('/root/Desktop/ml/football_players/'+i,0)
		print(y)
